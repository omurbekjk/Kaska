...
public class RVSearchPeopleAdapter extends RecyclerView.Adapter<RVSearchPeopleAdapter.PersonViewHolder> {
    Context context;
    UserJava vse;
        ...
        PersonViewHolder(final View itemView) {
            ...
            itemView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("uid", listVse.get(getAdapterPosition()).getId());
                    intent.putExtra("username", listVse.get(getAdapterPosition()).getUsername());
    ...
    ArrayList<UserJava> listVse;
    HashMap<Integer, Likes> likes = new HashMap<Integer, Likes>();

    public RVSearchPeopleAdapter(Context context) {
...
/*
            ...
            holder.textCaption.setText(vse.getEmail());
    ...
    public void updatePosts(ArrayList<UserJava> posts) {
        listVse = posts;
