...
public class EditPostActivity extends BaseActivity implements IPickResult {
    public static String TAG = "EditPostActivity";
...
//                user = newUser;
////                post  = firebaseFeedPostsRepository.getFeedPost(user.getUid(), postId).getValue();
////                Log.i("fetched post", post.toString());
//            }
//        });
